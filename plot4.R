...
##This section arranges the graphs 2X2, plots the graphs and saves them as a .png file.
...
plot(powertable$datetime, powertable$Voltage, type = "l", xlab = "datetime", 
     ylab = "Voltage")

plot(powertable$datetime, powertable$Global_reactive_power, type = "l", xlab = "datetime",
